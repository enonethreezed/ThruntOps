...
{: .warning }
**Fase 2 — not yet deployed.** Office abuse scenarios require the WEB VM (SMB shares, credential lures) which is planned for Fase 2. This documentation is preserved as implementation and testing reference.
