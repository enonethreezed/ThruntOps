...
|---|---|---|---|
| `elastic` | set in `elk-dual-2022.yml` | Kibana / Fleet API | `https://<range_ip>.20.1:5601` |
| `admin` (Splunk) | set in `splunk-dual-2022.yml` | Splunk Web | `http://<range_ip>.20.1:8000` |
| `admin` (Wazuh) | set in `wazuh-dual-2022.yml` | Wazuh Dashboard | `https://<range_ip>.20.1` |
...
- ⚠️ marks accounts with intentional vulnerabilities — see the [Vulnerabilities](https://github.com/enonethreezed/ThruntOps-vulnerabilities)
