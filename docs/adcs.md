...
- ADCS attack paths are currently implemented in `ranges/elk-adcs-2022.yml`, `ranges/wazuh-adcs-2022.yml`, and `ranges/splunk-adcs-2022.yml` (also available as `-2025`/`-2019` variants)
