...
bd issue exports are committed and pushed through git in this project:

- Each write auto-commits to Dolt history
- Commit `.beads/` changes with the related code changes
- Do not use Dolt remote sync commands here; they are not integrated for this project
