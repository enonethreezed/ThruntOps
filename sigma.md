...
{: .warning }
**Fase 2 — not yet deployed.** Infection Monkey runs on the OPS VM, which is planned for Fase 2. Sigma rule workflow and coverage matrix are preserved here as reference for when vulnerability scenarios are active.
