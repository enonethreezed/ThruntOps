#!/usr/bin/env bash
# Checklist de validación post-deploy — variante Elastic (ranges/elastic-core.yml)
...
#   RANGE_PREFIX=10.2 ./tests/elastic_checklist.sh
...
echo "Prefijo de red: ${RANGE_PREFIX}  (elastic: ${ELASTIC_IP})"
