...
{: .warning }
**Fase 2 — not yet deployed.** All vulnerability scenarios (ADCS, WEB, GitLab, LOLBins, privesc) are planned for Fase 2. This documentation is preserved as implementation and testing reference.
